  // Note: process.env.XX is the environment variable of Vercel. For the configuration method, see: https://docs.tangly1024.com/article/how-to-config-notion-next#c4768010ae7d44609b744e79e2f9959a
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'An ordinary jobber 🍚', // 作者简介
