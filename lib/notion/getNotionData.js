...
const EmptyData = (pageId) => {
  const empty = {
    ...
    allPages: [{ id: 1, title: `Không thể lấy dữ liệu Notion, vui lòng kiểm tra Notion_ID: \n Hiện tại: ${pageId}`, summary: 'Truy cập tài liệu để được trợ giúp → https://tangly1024.com/article/vercel-deploy-notion-next', status: 'Published', type: 'Post', slug: '13a171332816461db29d50e9f575b00d', date: { start_date: '2023-04-24', lastEditedDay: '2023-04-24', tagItems: [] } }],
    allNavPages: [],
    collection: [],
    collectionQuery: {},
    collectionId: null,
